        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">កែប្រែព័ត៌មាន អ្នកប្រើប្រាស់</h3>
                </div>
                <div class="card-body">
                    <form id="userForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control" id="type">
                                ...
                                <option value="2" {{ $user->type == 2 ? 'selected' : '' }}>Super Admin</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary" id="updateUser">កែប្រែ</button>
                    </form>
                </div>
            </div>
        </div>
